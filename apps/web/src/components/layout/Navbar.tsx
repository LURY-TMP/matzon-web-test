          ...
          <div className="absolute top-[10px] right-4 sm:right-6 lg:right-8 z-[200] flex flex-col items-end">
            ...
            >
              <div className="w-[24px] h-[24px] relative">
                <motion.span
                  animate={{ top: isOpen ? 10.5 : 4, rotate: isOpen ? 45 : 0 }}
                  className="block w-full h-[3px] absolute left-0 transition-colors duration-500"
                  style={{ backgroundColor: isLightMode ? '#FFF' : '#000' }}
                />
                <motion.span
                  animate={{ opacity: isOpen ? 0 : 1, top: 10.5 }}
                  className="block w-full h-[3px] absolute left-0 transition-colors duration-500"
                  style={{ backgroundColor: isLightMode ? '#FFF' : '#000' }}
                />
                <motion.span
                  animate={{ top: isOpen ? 10.5 : 17, rotate: isOpen ? -45 : 0 }}
                  className="block w-full h-[3px] absolute left-0 transition-colors duration-500"
                  style={{ backgroundColor: isLightMode ? '#FFF' : '#000' }}
                />
              </div>
