  ...
  return (
    <div style={{ backgroundColor: '#0B121E', color: '#fff', fontFamily: "'Inter',sans-serif", minHeight: '100vh', paddingBottom: 40 }}>
      ...
      <div style={{ padding: '80px 20px 20px' }}>
        <h1 style={{ fontSize: 20, fontWeight: 800, lineHeight: 1.2, marginBottom: 20 }}>
          Esteja preparado quando o mundo se unir!
        </h1>
          ...
          <div style={{ display: 'flex', gap: 12, padding: 15, borderBottom: '1px solid #262F44' }}>
            ...
            <div>
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 6, fontSize: 10, color: '#9AA4B6', fontWeight: 600, textTransform: 'uppercase' }}>
                <img src="https://ui-avatars.com/api/?name=RL&background=005EFA&color=fff&rounded=true" style={{ width: 14, height: 14, borderRadius: '50%' }} />
                <span>15/12 - 19/12/2025</span>
                <span>•</span>
                ...
                <div key={i} style={{ backgroundColor: '#1C2436', borderRadius: 8, padding: 10, display: 'flex', alignItems: 'center', gap: 15, minWidth: 180, flexShrink: 0 }}>
                  <div style={{ display: 'flex', flexDirection: 'column', gap: 6, flex: 1 }}>
                    <div style={{ fontSize: 12, fontWeight: 600, display: 'flex', justifyContent: 'space-between' }}>
                      <span>{m.team1}</span>
                      {m.done && <span style={{ color: m.r1 === 'W' ? '#fff' : '#9AA4B6', fontWeight: 700 }}>{m.r1}</span>}
                    </div>
                    <div style={{ fontSize: 12, fontWeight: 600, display: 'flex', justifyContent: 'space-between' }}>
                      <span>{m.team2}</span>
                      {m.done && <span style={{ color: m.r2 === 'W' ? '#fff' : '#9AA4B6', fontWeight: 700 }}>{m.r2}</span>}
                    </div>
                  </div>
      ...
      <div style={{ display: 'flex', gap: 10, padding: '0 20px', marginBottom: 20 }}>
        ...
        <button style={{ backgroundColor: '#1C2436', border: 'none', color: '#005EFA', width: 45, height: 45, borderRadius: 8, fontSize: 20, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer' }}>⚙</button>
      </div>
